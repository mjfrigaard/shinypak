...
The primary goal of `shinypak` is to provide easy access all the application examples in [`moviesApp`](https://github.com/mjfrigaard/moviesApp).[^all-apps]
...
```{r remotes, message=FALSE, warning=FALSE, results='hide'}
