...
package).[¹](#fn1) `shinypak` also has a few helper functions for
checking the files and folders in a Shiny app-package.
...
automatically using the `credentials` package).[²](#fn2)
